...
<table class="ui celled table">
  ...
  <tbody>
    <tr>
      <td data-label="pintura">Pintura</td>
      <td data-label="musica">3 anos</td>
      <td data-label="teatro"><i class="large green checkmark icon"></i></td>
      <td data-label="danca">Noturno</td>
    </tr>
    <tr>
     <td data-label="musica">Música</td>
      <td data-label="Age">5 anos</td>
      <td data-label="Job"><i class="large green checkmark icon"></i></td>
      <td data-label="Job">Diurno</td>
    </tr>
    <tr>
      <td data-label="teatro">Teatro</td>
      <td data-label="Age">100 anos</td>
      <td data-label="Job"><i class="large green checkmark icon"></i></td>
      <td data-label="Job">Diurno</td>
    </tr>
    <tr>
       <td data-label="danca">Dança</td>
      <td data-label="Age">1 ano</td>
      <td data-label="Job"><i class="large green checkmark icon"></i></td>
      <td data-label="Job">Diurno</td>
    </tr>
  </tbody>
